...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pzdc features */
        {"pzdc", "masternode", &masternode, true, true, false},
        {"pzdc", "listmasternodes", &listmasternodes, true, true, false},
        {"pzdc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pzdc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pzdc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pzdc", "masternodedebug", &masternodedebug, true, true, false},
        {"pzdc", "startmasternode", &startmasternode, true, true, false},
        {"pzdc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pzdc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pzdc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pzdc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pzdc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pzdc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pzdc", "mnbudget", &mnbudget, true, true, false},
        {"pzdc", "preparebudget", &preparebudget, true, true, false},
        {"pzdc", "submitbudget", &submitbudget, true, true, false},
        {"pzdc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pzdc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pzdc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pzdc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pzdc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pzdc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pzdc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pzdc", "checkbudgets", &checkbudgets, true, true, false},
        {"pzdc", "mnsync", &mnsync, true, true, false},
        {"pzdc", "spork", &spork, true, true, false},
        {"pzdc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"pzdc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use pzdcd, or the -server option to pzdc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"PZDC Alert\" admin@foo.com\n"),
...
{
    return "> pzdc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21213/\n";
}
