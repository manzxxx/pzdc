                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PZDC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PZDC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pzdc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PZDC Core"), this);
    aboutAction->setStatusTip(tr("Show information about PZDC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PZDC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PZDC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PZDC addresses"));
    ...
    openAction->setStatusTip(tr("Open a PZDC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PZDC Core help message to get a list with possible PZDC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PZDC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PZDC network", "", count));
}
...
{
    QString strTitle = tr("PZDC Core"); // default title
